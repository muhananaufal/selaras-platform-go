// Command coaching-svc melayani kontrak coaching.v1 di atas gRPC.
package main
...
import (
	...
	"github.com/muhananaufal/selaras-platform-go/internal/coaching"
	coachinggrpc "github.com/muhananaufal/selaras-platform-go/internal/coaching/adapter/grpc"
...
func main() {
	...
	if err := run(log); err != nil {
		log.Error("coaching-svc stopped", "error", err)
		os.Exit(1)
	}
	log.Info("coaching-svc stopped cleanly")
}
